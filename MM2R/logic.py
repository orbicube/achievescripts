...
ach_flags = [ # ID, Badge, Title, Description, Points, Type, Flag Address, Map ID, Extra Flags
	(625233, 714598, "Surveying the Damage", "Clear away the rubble of Mado's destroyed buildings, paving the way for new structures",
		1, None, bit0(0x0019e91a), maps["Mado"], None),
	(625234, 714599, "Ol' Reliable", "Receive a repaired vehicle from Nile at the Mado Garage",
		2, None, bit2(0x0019e91a), maps["Mado Garage"], None),	
	(625235, 714600, "Early Check Out", "Rescue Khatia from the Grapplers running the El Niño Inn",
		3, None, bit1(0x0019e952), maps["El Nino Inn"], None),
	(625236, 714601, "Neither Toothless nor Gutless", "Become a member of the Mindless, gaining access to party member recruitment",
		3, None, bit7(0x0019e952), maps["El Nino Mindless Hideout"], None),
	(625237, 714602, "Chip Shortage", "Give Schriette in the Mindless hideout 25 Electronic Parts",
		3, None, bit4(0x0019e957), maps["El Nino Mindless Hideout"], None),
	(625238, 714603, "Amateur Detectorist", "Find and return Anne's Ring to Irish in the camp east of Mado",
		2, None, bit1(0x0019e924), maps["Trader Camp (Harley Ring)"], None),
	(625239, 714604, "Wheels of Freedom", "Purchase the vehicle being offered for sale at the trader camp east of Mado",
		1, None, bit7(0x0019e9fa), maps["Trader Camp (Harley Ring)"], None),
	(625240, 714647, "Welcome to Flavortown", "Fulfil Irit's culinary curiosity by giving her a Cookbook and Curry Powder",
		2, None, bit3(0x0019e93a), maps["Mado Garage"], None),
	(625241, 714611, "Antares Antagonist", "Destroy Antares for a Hunter in a bar east of Mado, receiving the keys to a vehicle as your reward",
		4, None, bit5(0x0019e925), maps["Nameless Bar"], None),
	(625242, 714612, "Not Even a Penny?", 'After completing the quest "Motorcycle of Revenge", decline to give the Hunter any money, earning the title of "Stingy Hunter"',
		1, None, bit5(0x0019e759), maps["Nameless Bar"], [(bit5(0x0019e925), True)]),
	(625243, 714613, "No Child Left Behind", "Find the missing girl Rinka and return her to her parents",
		3, AchievementType.MISSABLE, bit1(0x0019e926), maps["Trader Camp (Rinka Parents)"], None),
	(625244, 714616, "Life Finds a Way", "Find evidence of the last remaining Chihuahua for Mack in Hatoba",
		3, None, bit5(0x0019e949), maps["Hatoba Ferry Terminal"], None),
	(625245, 714618, "Them!", "Rescue Moriniu from Adam Ant's captivity after he gets abducted collecting wood for Mado's new building",
		3, AchievementType.MISSABLE, bit7(0x0019e922), maps["Forest Watchtower"], None),
	(625246, 714621, "Improvised Explosive Dandelion", "Bring Sakae at the Trader Camp north of Hatoba his Bombdelion Fluff, receiving a supply of explosives",
		3, None, bit3(0x0019e946), maps["Trader Camp (Bombdelion) Tent"], None),
	(625247, 714622, "Towards Sanctuary", "Escort the traders safely from Hatoba to Azusa",
		3, None, bit2(0x0019e931), maps["Azusa Bottom"], None),
	(626287, 714623, "Just Needed a Push", "Open the tunnel from Hatoba to Bazaarska",
		1, None, bit0(0x0019e91d), maps["Bito's Tunnel"], None),
	(625248, 714624, "Can't Run, Can't Hide", "Hunt the Greater Manta using Zushio's Signal Bullet technology",
	...
	(625253, 714632, "You'll Turn That Easily?", 'Upon arriving at Delta Rio by boat, accept the Grappler\'s invitation to join, earning the title of "Bad Rookie"',
		1, AchievementType.MISSABLE, bit2(0x0019e9d4), maps["Delta Rio Ferry Terminal"], [(bit2(0x0019e759), True)]),
	(625254, 714635, "In from the Cold", "Find the spy within Mendoza's inner circle and deliver their report to Richie",
		2, None, bit7(0x0019e956), maps["El Nino Mindless Hideout"], None),
	(625255, 714637, "Cooking the Books", 'Report 300G of sales while tending the ill trader\'s shop, earning the title of "Shrewd Salesperson"',
		1, AchievementType.MISSABLE, bit6(0x0019e75a), maps["Trader Camp (Shopkeep) Left Tent"], None),
	(625256, 714639, "MarilynLivingSpace", 'Buy an apartment for Marilyn in Delta Rio and fulfil her request to decorate it, earning the title of "Marilyn\'s Daddy"',
		2, AchievementType.MISSABLE, bit6(0x0019e75e), maps["Delta Rio Boat Shops"], None),
	(625257, 714641, "Caught with Your Pants Down", "Defeat the monster hiding in Natalie's closet in Delta Rio",
		3, None, bit7(0x0019e946), maps["Delta Rio Apartments 3F"], None),
	(625258, 714642, "Pichi Pichi on the Coast", "Defeat the Pichi Pichi Brothers after falling into their trap west of Delta Rio",
		3, None, bit3(0x0019e932), maps["Mundane Ruins (Delta Rio)"], None),
	(625259, 714646, "Salvaged Love", "Salvage and return the Silver Music Box to Saki at Bennett's House",
		2, None, bit4(0x0019e92a), maps["Bennett's House"], None),
	(625260, 714648, "Mechanical Grudge", 'Complete "Mechanical Employee" without Brute dying',
		2, AchievementType.MISSABLE, bit7(0x0019e941), maps["Islaporto Dock"], [(bit1(0x0019ea13), False)]),
	(625261, 714649, "Unusual Delicacy", "Retrieve an Ant Egg for the barkeep in Hatoba",
		5, None, bit5(0x0019e943), maps["Hatoba Bar"], None),
	(625262, 714650, "I've Lost My Mojo!", "Return Kenzie's macho extract that was stolen from him near Salon du Princess",
		3, AchievementType.MISSABLE, bit0(0x0019e931), maps["Overworld"], None),
	(625263, 714652, "Petrochemical Potential", "Deliver Oiholotoxin to the doctor in Isalporto, gaining access to an endless supply of medication",
		2, None, bit4(0x0019e9d6), maps["Islaporto Hospital"], None),
	(625264, 714653, "Am I Me?", "Help Danny in Islaporto eliminate his clones",
		3, None, bit6(0x0019e94c), maps["Islaporto"], None),
	(625265, 714656, "Marble Madness", "Return the item believed to be stolen from the tourist visiting Taisha",
		2, None, bit2(0x0019e94e), maps["Taisha"], None),
	(625266, 714657, "Profane Profit", "Destroy the saisen outside Taisha's shrine, taking the offerings to the God of War for yourself",
		3, None, bit3(0x0019e945), maps["Taisha"], None),
	(625267, 714658, "Big Egg", 'Complete "The Ice Excavator" after destroying all of Taisha\'s ice walls',
		4, AchievementType.MISSABLE, bit3(0x0019e92f), maps["Taisha Ice Cave"], [(bit1(0x0019e9e6), True)]),
	(625268, 714659, "Roadside Assistance", "Give the stranded vehicle near Taisha a new engine",
		2, None, bit2(0x0019e938), maps["Overworld"], None),
	(625269, 714660, "Stay Hydrated", "Complete Dan's request to help his sister Cecile in Islaporto",
		3, None, bit5(0x0019e923), maps["Islaporto Sewers"], None),
	(625270, 714661, "What Happened Last Night?", "Hunt the Trash Giant for Jin in Delta Rio, stopping the rampage of Wild Buses",
		5, None, bit4(0x0019e928), maps["Trader Camp (Scrap Metal)"], None),
	(625271, 714664, "Lighthouse Liberation", "Defeat Mendoza and free El Niño from the Grappler tyranny",
		10, None, bit0(0x0019e958), maps["El Nino Observatory"], None),
	(625272, 714665, "Precious Family... Appliance?", "Find the golden fridge that was stolen from Emma in El Niño",
		1, None, bit2(0x0019e959), maps["El Nino Observatory 3F"], None),
	(625273, 714666, "Messy Business Arrangements", "Tow the lost ship back to Delta Rio",
		2, None, bit7(0x0019e944), maps["Delta Rio"], None),
	(625274, 714667, "Unbothered. Moisturized. Happy. In My Tent. Focused. Flourishing", "Help the witch Jella in brewing a potion north of Islaporto",
		4, None, bit7(0x0019e92f), maps["Witch Tent"], None),
	(625275, 714670, "Pichi Pichi in the Wind", "Defeat the Pichi Pichi Brothers after falling into their trap near the Wind Farm",
		4, None, bit7(0x0019e933), maps["Trader Camp (Wind Farm)"], None),
	(625276, 714671, "Stablizing Succor", "After finding the Combotron for Anri in Taisha, give her some Atomic Stabilizer to heal her child",
		4, None, bit4(0x0019ea36), maps["Taisha Residential Building 3F"], [(bit6(0x0019e94f), True)]),
	(625277, 714672, "Loch Locusts", "Clear the pleague of Aqua Walkers near Helmets island for the salvager in Isalporto",
		5, None, bit2(0x0019e93f), maps["Islaporto Salvage"], None),
	(625278, 714675, "Shooting Blanks", "Settle the duel between Marco and Izu in Swan with neither dying",
		3, AchievementType.MISSABLE, bit2(0x0019e944), maps["Swan Inside"], [(bit0(0x0019ea1f), False)]),
	(625279, 714676, "The Master of Unlocking", "After acquiring the Lock Hacker, use it to open every lock in the world",
		5, None, bit1(0x0019e94d), None, [(bit3(0x0019e94d), True)]),
	(625280, 714678, "None of My Business", "Free the man stuck in a closet in the Delta Rio apartments",
		1, None, bit4(0x0019e9a3), maps["Delta Rio Apartments"], None),
	(625281, 714679, "Chariot of the Lake", "Return Swan to its former glory, gaining its use as a ship",
		5, None, bit6(0x0019e92d), maps["Swan Outside"], None),
	(625282, 714683, "Nostalgic Nourishment", "Give Bennett a taste of his youth with some canned ramen",
		3, None, bit6(0x0019e92b), maps["Bennett's House"], None),
	(625283, 714684, "Without a Trace", "Figure out what happened to Toko of Islaporto's husband",
		5, None, bit0(0x0019e92b), maps["Islaporto Bar 2F"], None),
	(625284, 714685, "Case Closed", "Solve the murder mystery at the Nadir hotel",
		5, None, bit0(0x0019e93b), maps["Nadir Outside"], None),
	(625285, 714686, "Eye for an Eye", "Find Tony's murderer hiding from society and deliver retribution",
		3, None, bit6(0x0019e935), (maps["Freak Island Cave to Groween"], maps["Freak Island Jungle"]), None),
	(625286, 714687, "Escape from Freak Island", "Find Latoya on Freak Island and bring her back to her family",
		4, None, bit4(0x0019e935), maps["Latoya's House"], None),
	(625287, 714692, "Built for Love", "Figure out Marilyn's secret at her apartment in Delta Rio",
		1, None, bit6(0x0019e9d6), maps["Delta Rio Apartments 2F"], [(bit5(0x0019e9d6), False), (bit3(0x0019e8c7), True)]),
	(625288, 714693, "Alleviating Ailments", "Fulfill Dan's second request to help his sister Cecile in Islaporto",
		2, None, bit3(0x0019e923), maps["Islaporto Sewers"], None),
	(625289, 714694, "Empty Nester", "Find and return Cecile's missing Money Eater",
		4, None, bit6(0x0019e924), maps["Islaporto Sewers"], None),
	(625290, 714695, "Enthralled in Ecstasy", "Bring Luckyna some Blue Crab Pincers for... personal use",
		3, None, bit5(0x0019e930), maps["Trader Camp (Luckyna)"], None),
	(625291, 714697, "Arm Wrestling Contest Winner", 'Complete "Single Arm on the Lakebed" with Goodman and Irena surviving',
		4, AchievementType.MISSABLE, bit6(0x0019e93f), maps["Abandoned Building (Armgun)"], [(bit1(0x0019ea00), False)]),
	(625292, 714698, "Bickering Until the End", "Settle the feud between the three brothers trying to marry Jenny in Moro Poco",
		3, None, bit5(0x0019e94b), maps["Moro Poco 3F"], None),
	(625499, 714703, "Look Around You", "Repair Michael inside Devil Island, then find eight Space Parts using his scanner",
		4, None, bit0(0x0019e934), maps["Overworld"], None),
	(625500, 714704, "Comfort at What Cost?", "Complete all three of Hyde's escalating requests to alleviate his suffering at the Staff Housing",
		10, AchievementType.MISSABLE, bit6(0x0019e938), maps["Staff Housing"], None),
	(625501, 714705, "Radical Radish Remedies", "Fulfil Dan's third and final request to help Cecile's illness",
		5, None, bit1(0x0019e923), maps["Islaporto Sewers"], None),
	(625502, 714708, "No Rehabilitation, Only Revolution", "Defeat the warden of Deathcruz, liberating the prison town",
		10, None, bit1(0x0019e921), maps["Deathcruz Roof"], None),
	(625503, 714709, "Monster Closet", "Retrieve the lost coin for Dallas in Deathcruz",
		3, None, bit6(0x0019e940), maps["Deathcruz Interior"], None),
	(625504, 714711, "Would Hate to See Their Overdue Fees", "Find and return the missing 13th rental tank for the receptionist at Melt-Town",
		2, None, bit6(0x0019e931), maps["Melt-town Interior"], None),
	(625505, 714713, "Cross-Continental Courier", 'Carry cargo shipments from Hoc\'s Trading Post to Melt-town, earning the title of "Wasteland Courier"',
		4, AchievementType.MISSABLE, bit5(0x0019e93a), maps["Melt-town Interior"], None),
	(625506, 714717, "Pichi Pichi in the Fog", "Defeat the Pichi Pichi Brothers after falling into their trap west of Melt-town",
		5, None, bit5(0x0019e933), maps["Mundane Ruins (Rain Valley)"], None),
	(625507, 714719, "Become Eternal", "Open the path from the Eternal Gate to Bias City",
		5, None, bit7(0x0019ea29), maps["Eternal Gate MB"], None),
	(625508, 714720, "Leave Your Biases at the Door", "Use the Synchronizer to unlock the entrance to Bias City",
	...
	(625513, 714754, "Practically a Metropolis", "Rebuild the third building in Mado",
		5, None, bit6(0x0019ea3c), maps["Mado"], None),
	(625514, 714755, "Worth the Wait", "Hold the wrestler's spot in line at the rebuilt Mado Pharmacy",
		1, None, bit7(0x0019e953), maps["Mado Pharmacy"], None),
	(625515, 714756, "Back to School", 'Complete both combat lessons in the rebuilt Mado School, earning the title of "Super Adult"',
		3, None, bit1(0x0019e75b), maps["Mado School"], [(bit4(0x0019ea60), True), (bit3(0x0019ea60), True)]),
	(625516, 714757, "Long Lost Libations", "Sell 10 bottles of vintage liquor to the rebuilt Mado Bar",
		2, None, bit5(0x0019e953), maps["Mado Bar"], None),
	(625517, 714758, "Skittish Customer", "Deliver a package from Smith in the rebuilt Mado Bar to the Human Village",
		2, None, bit2(0x0019e933), maps["Human Village"], None),
	(625518, 714759, "Sin City", "Repair all machines in the rebuilt Mado Casino",
...
ach_cannon = Achievement(id=626131, badge=714712, title="Cannon Connoisseur",
...
ach_allie = Achievement(id=625644, badge=714617, title="Reunited Lovers",
...
ach_bounties = [ # ID, Badge, Title, Description, Points, Type, Name, Map
	(625293, 714605, "Like a Shark out of Water", "Defeat the Sand Shark in the desert east of Mado",
		3, None, "Sand Shark", maps["Overworld"]),
	(625294, 714606, "Desperoid for Attention", "Defeat the Desperoid near El Niño",
		3, None, "Desperoid", maps["Overworld"]),
	(625295, 714619, "Adam Ant-ium", "Defeat Adam Ant inside its nest near the Forest Watchtower",
		5, None, "Adam Ant", maps["Giant Ant Cave B4F"]),
	(625296, 714620, "Recursive Symmetry", "Defeat the Thousand Radiata in the forest west of Hatoba",
		5, None, "Thousand Radiata", maps["Overworld"]),
	(625297, 714630, "Rhino Gone", "Defeat the Rhinogon in the deserts near Bar Thirsty",
		4, None, "Rhinogon", maps["Overworld"]),
	(625298, 714634, "Monkey Wrenched", "Defeat Skunks atop the Grappler Tower",
		10, AchievementType.PROGRESSION, "Skunks", maps["Grappler Tower 10F"]),
	(625299, 714645, "Myth No Longer", "Defeat the Myth Ladybug near Nobotoke Village",
		10, None, "Myth Ladybug", maps["Overworld"]),
	(625300, 714651, "Intense Workout Session", "Defeat Madam Muscle in the Protein Palace",
		10, None, "Madam Muscle", maps["Protein Palace B5F"]),
	(625301, 714654, "Intruder Alert", "Defeat the Kamikaze King northeast of Islaporto",
		10, None, "Kamikaze King", maps["Overworld"]),
	(625302, 714663, "From Hell's Heart I Shoot at Thee", "Defeat U-Shark, completing Captain Beihab's quest for vengeance and acquiring your own ship",
		10, AchievementType.PROGRESSION, "U-Shark", maps["Overworld"]),
	(625303, 714668, "Fighting Flying Fish for Funds", "Defeat the Flying Fish lurking in the waters near Delta Rio",
		5, None, "Flying Fish", maps["Overworld"]),
	(625304, 714669, "From the Flash Game?", "Defeat the Dust Hominid inside the Wind Farm",
		5, None, "Dust Hominid", maps["Wind Farm B1F"]),
	(625305, 714673, "Totally Turtle! Totally Party", "Defeat the Total Turtle in the waters west of Islaporto",
		5, None, "Total Turtle", maps["Overworld"]),
	(625306, 714681, "Broken RNG", "Defeat the Vile Vendor within the Vending Paradise",
		10, None, "Vile Vendor", maps["Vending Paradise Inside"]),
	(625307, 714682, "Ethereal Eviction", "Defeat the ghost haunting hotel Nadir",
		10, None, "Nadir Ghost", tuple(range(0x167, 0x176))),
	(625308, 714688, "Freak: Matched", "Defeat Groween in the depths of Freak Island",
		10, None, "Groween", maps["Groween"]),
	(625309, 714691, "No Castles in Sight", "Defeat Cagliostro within the Dark Canal",
		10, None, "Cagliostro", maps["Dark Canal 2F"]),
	(625310, 714696, "Mon-Star See, Mon-Star Do", "Defeat the Sea Mon-Star in the valley near Moro Poco",
		5, None, "Sea Mon-Star", maps["Overworld"]),
	(625311, 714699, "Safety Inspection Failed", "Defeat the Mimic Stairs in Moro Poco",
		10, None, "Mimic Stairs", (maps["Moro Poco"], maps["Moro Poco 2F"])),
	(625312, 714702, "Bullfrog in Boiling Water", "Defeat Bullfrog at Devil island",
		10, None, "Bullfrog", maps["Devil Island"]),
	(625313, 714706, "Don Your Goggles, Sandstorm Approaching", "Sense and defeat Sandy Dandy in the desert east of South Gate",
		10, None, "Sandy Dandy", maps["Overworld"]),
	(625314, 714707, "Save the Daedalus", "Defeat the Daedalus in the desert west of South Gate",
		10, None, "Daedalus", maps["Overworld"]),
	(625315, 714714, "When Dogs Fly", "Defeat the Hovering Dog in Rain Valley",
		10, None, "Hovering Dog", maps["Rain Valley"]),
	(625316, 714715, "You Sunk My Dinosaur", "Defeat the Battleshipsaurus in Rain Valley",
...
ach_hunts = [ # ID, Badge, Title, Description Override, Points, Hunts Required
	(625321, 714740, "Sprouting Challenger", 'Clear 10 Challenge Hunts, earning the title of "Challenger"', 5, 10),
	(625322, 714741, "Budding Challenger", '', 5, 20),
	(625323, 714742, "Flowering Challenger", '', 10, 30),
	(625324, 714743, "Blooming Challenger", '', 10, 40),
	(625325, 714744, "Evergreen Challenger", 'Clear all 56 Challenge Hunts', 25, 56)
]
...
ach_database = [ # ID, Badge, Title, Description, Points, Type, Threshold
	(625326, 714745, "Research Assistant", "25%", 5, None, 120),
	(625327, 714746, "Adept Biographer", "50%", 10, None, 242),
	(625328, 714747, "Comprehensive Taxonomist", "99%", 50, AchievementType.MISSABLE, 488)
]
...
ach_chars_human = [ # ID, Badge, Title, Description, Points, Character, Maps
	(625329, 714610, "El Niño Espionage", "Free Axel from captivity in El Niño, recruiting him to your party",
		4, 1, maps["El Nino"]),
	(625331, 714638, "You Only Live Thrice", "Rekindle Miska's undying spirit, recruiting her to your party",
...
ach_chars_animal = [  # ID, Badge, Title, Description, Points, Character, Maps
	(625330, 714614, "Pick of the Litter", "Find Pochi in the Dog Village, recruiting them to your party",
		3, 0x0f, maps["Dog Village"]),
	(625332, 714640, "They Grow Up So Fast", "Grow a Money Eater, recruiting it into your party",
		3, 0x13, (maps["Mado Garage"], maps["Bennett's House"], maps["Delta Rio Apartments 2F"])),
	(625333, 714644, "Truly Ferocious", "Encounter and defeat the Demon Dog Licky in the plains of Nobotke, recruiting them to your party",
		4, 0x10, maps["Overworld"]),
	(625334, 714655, "Tempting the Guardian", "Feed Hachi its favorite treat in Taisha, recruiting them to your party",
...
ach_levels = [ # ID, Badge, Title, Points, Class, Index, Threshold
	(625335, 714730, "Following in Maria's Footsteps", 3, "Any", -1, 20),
	(625336, 714731, "Forging a New Path", 5, "Any", -1, 40),
	(625337, 714732, "To the Ends of the Earth", 10, "Hunter", 0, 60),
	(625338, 714733, "Vehicle Whisperer", 10, "Mechanic", 1, 60),
	(625339, 714734, "Guns Blazing", 10, "Soldier", 2, 60),
	(625340, 714735, "Nurturing Touch", 10, "Nurse", 3, 60),
	(625341, 714736, "Who Grapples the Grapplers?", 10, "Wrestler", 4, 60),
	(625342, 714737, "Flourishing Art Scene", 10, "Artist", 5, 60),
	(625343, 714738, "Max's Best Friend", 10, "Dog", 6, 60),
	(625344, 714739, "Paying Dividends", 10, "Money Eater", 7, 60)
]
...
progression_bridge = Achievement(id=625345, badge=714609, title="Unpaid Tolls",
...
challenge_bridge = Achievement(id=625346, badge=714608, title="You and What Army?",
...
challenge_skunks = Achievement(id=625347, badge=714633, title="It'll Buff Out",
...
challenge_ushark = Achievement(id=625348, badge=714662, title="Feel the Lake Breeze",
...
challenge_fog = Achievement(id=625519, badge=714716, title="Cryptid Sighting",
...
challenge_ted = Achievement(id=625352, badge=714721, title="Searing Critique",
...
progression_vlad = Achievement(id=625353, badge=714724, title="Vlad Vanquisher",
...
challenge_vlad = Achievement(id=625354, badge=714723, title="No Camping Within City Limits",
...
ach_kills = [ # ID, Badge, Title, Description, Points, Threshold, Title
	(625355, 714748, "Why's Everyone So Hostile?", 'Defeat 1,000 enemies, earning the title of "Thousand Killer"',
		5, 1000, bit3(0x0019e75f)),
	(625356, 714749, "Cycle of Violence", 'Defeat 5,555 enemies, earning the title of "5555 Kills Leader"',
		10, 5555, bit1(0x0019e75f)),
	(625357, 714750, "Maximum Carnage", 'Defeat 10,000 enemies, earning the title of "The Ace"',
...
challenge_kills = Achievement(id=625358, badge=714751, title="They Just Keep Coming",
...
ach_vehicles = [ # ID, Badge, Title, Description, Points, Vehicle Index, Map, Extra Flags
	(625359, 714626, "From Murder Weapons to Hospitals", "Complete a tour of the Vlad Museum, liberating the vehicle housed within",
		4, 4, maps["Vlad Museum B1F"], [(bit7(0x0019e9fc), True)]),
	(625360, 714631, "Oh, That's Where I Parked It!", "Find the vehicle buried in the desert near Bar Thirsty",
		3, 2, maps["Overworld"], [(bit0(0x0019e8a8), True)]),
	(625361, 714643, "Public Transport", "Find the hidden bus stop near Nobotoke and wrangle a Wild Bus",
		4, 3, maps["Overworld"], [(bit3(0x0019e8aa), True)]),
	(625362, 714677, 'Cry "Havoc!" and Let Slip the God of War', "Steal the God of War from Taisha's shrine",
		3, 5, maps["Taisha Shrine"], [(bit1(0x0019e9d6), True)]),
	(625363, 714680, "Metal for Nothing and Your Tanks for Free", "Create your very own tank with the help of Professor Bato",
		10, 8, maps["Bato Lab"], [(bit6(0x0019e75b), True)]),
	(625364, 714689, "Always Wear a Helmet", "Find the vehicle stored within Helmets Island",
		5, 7, maps["Helmets Island B2F Room 7"], None),
	(625365, 714700, "One Way Out", "Find the vehicle deep within Deadend Cave",
		5, 6, maps["Deadend Cave B5F"], [(bit2(0x0019ea13), True)]),
	(625366, 714710, "Bury Me with My Tank", "Raise the vehicle out of the Buried Building, claiming it as your own",
...
ach_worldmaps = [ # ID, Badge, Title, Description, Points, Threshold
	(625520, 714762, "Acclimation", "Fill in 25% of the overworld map", 3, 140),
	(625521, 714763, "Exploration", "Fill in 50% of the overworld map", 5, 280),
	(625522, 714764, "Subjugation", 'Fill in all of the overworld map, earning the title of "World Traveler"',
		10, 560)
]
...
ach_minigames = Achievement(id=625609, badge=714774, title="Rigged in Your Favour", points=4, type=None,
...
ach_ribbitrace = Achievement(id=625371, badge=714775, title="Froggy Derby",
...
ach_tanks_score = Achievement(id=625901, badge=714776, title="Pro Wargamer",
...
ach_tanks_combo = Achievement(id=625902, badge=714777, title="Sharpshooter Supreme",
...
###########
## Misc
ach_igoggles = Achievement(id=625367, badge=714597, title="From the Ashes",
...
ach_dogs = Achievement(id=625369, badge=714615, title="Free to a Good Home",
...
ach_modders = Achievement(id=625523, badge=714760, title="Pit Crew",
...
ach_dogsystem = Achievement(id=625524, badge=714761, title="Every Dog Has Its System",
...
ach_vending = Achievement(id=625370, badge=714766, title="Your Lucky Day",
...
ach_noguchi = Achievement(id=625525, badge=714767, title="Not a Placebo",
...
ach_metaldetector = Achievement(id=625551, badge=714769, title="All That Glitters",
...
ach_shellcraft = Achievement(id=625552, badge=714770, title="World of Shellcraft",
...
ach_millionaire = Achievement(id=626089, badge=714773, title="Post-Apocalyptic Monopolist",
...
ach_furniture = Achievement(id=626090, badge=714772, title="Extreme Makeover: Wasteland Edition",
...
ach_stamps = Achievement(id=626117, badge=714768, title="Stamped Out",
...
ach_rental = Achievement(id=626118, badge=714771, title="Rising Insurance Premiums",
...
ach_pichistore = Achievement(id=625372, badge=714636, points=2, type=AchievementType.MISSABLE,
...
ach_garcia = Achievement(id=625373, badge=714674, title="Unrequited Animosity",
...
ach_marriage = Achievement(id=625374, badge=714778, title="Someone Else to Live For", points=1, type=None,
