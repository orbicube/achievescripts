...
ach_flags = [ # ID, Badge, Title, Description, Points, Type, Flag Address, Map ID, Extra Flags
	...
	(625261, 0, "Unusual Delicacy", "Retrieve an Ant Egg for the barkeep in Hatoba",
	...
	(625276, 0, "Stablizing Succor", "After finding the Combotron for Anri in Taisha, give her some Atomic Stabilizer to heal her child",
